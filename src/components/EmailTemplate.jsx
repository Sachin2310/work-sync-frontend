          ...
          {emails && emails.length > 0 ? (
            emails.map((email, index) => {
              return (
                <div
                  key={index}
                  className="p-6 mt-5 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 font-normal text-gray-700 dark:text-gray-400"
                >
                  <p>
                    <b>To:</b> {email.email}
                  </p>
